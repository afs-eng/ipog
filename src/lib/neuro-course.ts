...
export const neuroCourseSections: NeuroCourseSection[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { title: "Vista medial do encéfalo", description: "Estruturas observadas em vista medial de um corte sagital do encéfalo.", materialSlug: "encefalo", topicSlug: "hemisferios-cerebrais" },
      { title: "Vista inferior do encéfalo", description: "Estruturas observadas na vista inferior do encéfalo.", materialSlug: "encefalo", topicSlug: "partes-do-encefalo" },
      { title: "Áreas de Brodmann", description: "Visão geral das áreas de Brodmann do córtex cerebral.", materialSlug: "encefalo", topicSlug: "areas-corticais" },
      { title: "Homúnculo motor e sensitivo", description: "Representação motora e sensitiva do corpo humano no córtex cerebral.", materialSlug: "encefalo", topicSlug: "giros-cerebrais" },
      ...
      { title: "Corte transversal do encéfalo", description: "Estruturas observadas em corte transversal do cérebro.", materialSlug: "encefalo", topicSlug: "telencefalo" },
      { title: "Vista coronal do encéfalo", description: "Estruturas internas do cérebro vistas ao nível do tálamo.", materialSlug: "encefalo", topicSlug: "partes-do-encefalo" },
    ],
  },
  {
    id: "diencefalo",
    ...
    lessons: [
      { title: "Visão geral do diencéfalo", description: "Introdução ao diencéfalo e estruturas relacionadas.", materialSlug: "encefalo", topicSlug: "partes-do-encefalo" },
  ...
  },
  {
    ...
    lessons: [
      { title: "Córtex cerebelar", description: "Vista anterior e superior do cerebelo.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "cerebelo" },
      { title: "Núcleos do cerebelo", description: "Núcleos profundos do cerebelo.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "ataxia-cerebelar" },
    ],
  },
  {
    ...
    lessons: [
      { title: "Introdução e anatomia de superfície do tronco encefálico", description: "Visão geral das partes e marcos anatômicos do tronco encefálico.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "tronco-encefalico" },
      { title: "Estrutura interna do bulbo", description: "Visão geral da estrutura anatômica interna do bulbo.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "tronco-encefalico" },
      { title: "Núcleos dos nervos cranianos", description: "Visão geral dos núcleos cranianos no tronco encefálico.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "nervos-cranianos" },
    ],
  },
  {
    ...
    lessons: [
      { title: "Meninges do encéfalo", description: "Anatomia e estrutura das meninges do encéfalo.", materialSlug: "meninges-e-ventriculos", topicSlug: "meninges" },
      { title: "Ventrículos do encéfalo", description: "Anatomia do sistema ventricular do encéfalo.", materialSlug: "meninges-e-ventriculos", topicSlug: "liquor" },
      { title: "Produção e circulação de líquido cefalorraquidiano", description: "Introdução ao líquido cefalorraquidiano e suas vias de circulação.", materialSlug: "meninges-e-ventriculos", topicSlug: "liquor" },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      { title: "Topografia e morfologia da medula espinal", description: "Introdução à morfologia externa e à topografia da medula espinal.", materialSlug: "medula-espinal", topicSlug: "medula-espinal" },
      { title: "Meninges espinais e raízes nervosas", description: "Introdução às camadas meníngeas e raízes nervosas da medula espinal.", materialSlug: "medula-espinal", topicSlug: "cisterna-lombar" },
      { title: "Morfologia interna da medula espinal", description: "Visão geral da morfologia interna e estrutura da medula espinal.", materialSlug: "medula-espinal", topicSlug: "medula-espinal" },
      { title: "Nervos espinais", description: "Explore a estrutura anatômica e a formação dos nervos espinais.", materialSlug: "medula-espinal", topicSlug: "medula-espinal" },
  ...
  },
  {
    ...
    lessons: [
      { title: "Tratos piramidais", description: "As vias motoras mais importantes do SNC.", materialSlug: "encefalo", topicSlug: "giros-cerebrais" },
  ...
  },
  {
    ...
    lessons: [
      { title: "Nervos cranianos", description: "Visão geral dos 12 nervos cranianos.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "nervos-cranianos" },
      ...
      { title: "Nervos oculomotor, troclear e abducente (NC III, IV & VI)", description: "Visão geral dos nervos cranianos associados aos movimentos oculares.", materialSlug: "cerebelo-e-tronco-encefalico", topicSlug: "nervos-cranianos" },
