...
const unidade1Questions: DevelopmentTextQuestion[] = [
  ...
  {
    prompt: "Nos primeiros 2 anos, o desenvolvimento do cérebro ocorre à frente do desenvolvimento do restante do corpo.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O resumo afirma que, nesse período, o desenvolvimento cerebral se adianta ao desenvolvimento do restante do corpo.",
  },
  {
  ...
  {
    prompt: "Os reflexos primitivos, como Moro, Babinski, marcha e preensão, desaparecem durante o primeiro ano de vida.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O resumo diferencia reflexos adaptativos, importantes para a sobrevivência, dos reflexos primitivos, que desaparecem durante o primeiro ano.",
  },
  {
    prompt: "Aos 2 anos, a criança tem aproximadamente metade da altura adulta e desenvolve habilidades motoras gerais e finas.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O material registra metade da altura adulta aos 2 anos e diferencia habilidades motoras gerais e finas.",
  },
  {
    prompt: "No estágio sensório-motor, de 0 a 2 anos, os bebês aprendem usando sentidos e ações motoras.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
  ...
  {
    prompt: "Entre 2 e 7 anos, o crescimento em peso e altura fica mais lento e os desenhos avançam de rabiscos a formas, esboços e figuras.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "Essas duas sequências são apresentadas no material sobre as características físicas, motoras e gráficas da faixa de 2 a 7 anos.",
  },
  {
    prompt: "Entre 7 e 11 anos, o estágio operatório-concreto envolve descentração, reversibilidade e lógica indutiva.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O resumo associa o estágio operatório-concreto a múltiplas variáveis, transformações reversíveis e princípios gerais derivados da experiência.",
  },
  {
    prompt: "Na idade escolar, metas claras, boa comunicação, apoio e incentivo são apresentados como elementos ligados ao desenvolvimento do pensamento lógico.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O material destaca escolarização e estimulação com metas claras, comunicação, apoio e incentivo.",
  },
];

const unidade2Questions: DevelopmentTextQuestion[] = [
  {
    prompt: "O inatismo apresenta a inteligência como um dom biológico que amadurece com o tempo.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "Essa é a formulação do inatismo apresentada no material.",
  },
  {
    prompt: "Para o empirismo apresentado, a inteligência é adquirida pela experiência e o sujeito é visto como uma folha em branco.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O material descreve o empirismo como uma concepção que enfatiza a experiência e compara o sujeito a uma folha em branco.",
  },
  {
    prompt: "No interacionismo, a inteligência é construída na interação do sujeito com o ambiente.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O interacionismo é definido nos resumos pela construção da inteligência na interação com o ambiente.",
  },
  {
  ...
  {
    prompt: "No construtivismo, sujeito e objeto são indissociáveis na construção do conhecimento.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "Indissociabilidade significa que sujeito e objeto são inseparáveis nesse processo de construção.",
  },
  {
    prompt: "O esquema é uma estrutura básica de organização da realidade e uma unidade fundamental do pensamento e da ação.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O material apresenta o esquema como base para processar informações e organizar pensamento e ação.",
  },
  {
    prompt: "Assimilação é modificar ou criar esquemas para atender às singularidades do objeto.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Falso",
    explanation: "Modificar ou criar esquemas caracteriza a acomodação; assimilação integra o novo aos esquemas existentes.",
  },
  {
    prompt: "A acomodação pode modificar esquemas existentes ou criar novos esquemas.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "A acomodação adapta o conhecimento às singularidades do objeto por meio da modificação ou criação de esquemas.",
  },
  {
...
const unidade3Questions: DevelopmentTextQuestion[] = [
  ...
  {
    prompt: "O estágio sensório-motor, de 0 a 2 anos, é caracterizado por comportamento motor e ausência inicial de representação mental do objeto.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O resumo descreve esse estágio pela ação motora e pela construção progressiva da representação.",
  },
  {
    prompt: "No período pré-operatório, de 2 a 7 anos, surgem a função simbólica, a representação, a linguagem e o jogo simbólico.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "Essas aquisições são associadas ao período pré-operatório nos resumos.",
  },
  {
    prompt: "A lógica transdutiva do período pré-operatório consiste em fazer generalizações amplas a partir de fatos relacionados.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Falso",
    explanation: "A lógica transdutiva liga fatos isolados que não mantêm relação e ainda não permite generalizações sobre os fatos.",
  },
  {
    prompt: "A principal característica do estágio operatório-concreto é a reversibilidade da ação interiorizada.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "O material define a reversibilidade da ação interiorizada como principal característica desse estágio.",
  },
  {
    prompt: "Descentração é pensar um objeto considerando vários aspectos e múltiplas variáveis.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "Descentração é apresentada como o pensamento que leva em conta múltiplas variáveis.",
  },
  {
  ...
  {
    prompt: "Reversibilidade é a capacidade de pensar uma transformação em apenas um sentido, sem operação inversa.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Falso",
    explanation: "Reversibilidade envolve uma ação interiorizada que pode ocorrer em sentidos inversos, como juntar e separar.",
  },
  {
    prompt: "O jogo de exercício é associado ao sensório-motor, o jogo simbólico ao pré-operatório e o jogo de regras ao período operatório.",
    options: ["Verdadeiro", "Falso"],
    correctAnswer: "Verdadeiro",
    explanation: "Essa é a sequência de tipos de jogo apresentada no material; jogos de construção aparecem como transição.",
  },
  {
